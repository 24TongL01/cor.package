...
##Comparison Against R's cor() Function In this section, we compare the cor_new() function with the built-in cor() function to verify both correctness and efficiency.
...
rcpp_result = cor_new_rcpp(x_large, y_large, method = "pearson", na_handle = "complete")
...
benchmark_results = bench::mark(
  ...
  cor_new_rcpp(x_large, y_large, method = "pearson", na_handle = "complete"),
  iterations = 5,
